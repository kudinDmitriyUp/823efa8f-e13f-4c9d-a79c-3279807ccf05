...
export const metadata: Metadata = {
  title: "Alpine Retreat - Luxury Mountain Hotel Switzerland",
  description: "Experience timeless Alpine elegance at Alpine Retreat. Luxury hotel in Swiss mountains with world-class spa, fine dining, and stunning mountain views.",
  keywords: "luxury hotel Switzerland, Alpine resort, Swiss mountains, mountain spa, luxury accommodation",
  openGraph: {
    title: "Alpine Retreat - Swiss Mountain Luxury",
    description: "Discover premium Alpine hospitality and mountain elegance in the heart of Switzerland",
    siteName: "Alpine Retreat",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Alpine Retreat - Luxury Mountain Hotel",
    description: "Experience Swiss Alpine elegance and world-class mountain hospitality"
  }
};
